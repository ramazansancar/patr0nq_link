    ...
    while i < len(lines):
        ...
        if line.startswith('#EXTINF'):
            ...
            if 'tvg-logo=""' in line or 'tvg-logo=' not in line:
                line = re.sub('tvg-logo="[^"]*"', 'tvg-logo="https://raw.githubusercontent.com/ramazansancar/patr0nq_link/main/tv-logo/tv-logo.png"', line)
                if 'tvg-logo=' not in line:
                    line = line.replace('group-title=', 'tvg-logo="https://raw.githubusercontent.com/ramazansancar/patr0nq_link/main/tv-logo/tv-logo.png" group-title=')
